...
description: Search, inspect, and cite notebook sources created by notebook-source. Use when answering questions from selected sources, checking source support, or producing source-grounded citations.
---

# Notebook Grounding

Use this skill after sources have been imported with `notebook-source`.
